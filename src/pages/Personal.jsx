...
const Personal = () => {
  ...
  const [todos, setTodos] = useState([
    {
      id: 1,
      heading: "Wash clothes",
      description: "Tommorrow, I have to wash my clothes",
      isOpen: false,
      isCompleted: true,
    },
    {
      id: 2,
      heading: "Attend a party",
      description: "Shoaib abi has invited for his birthday part on Friday.",
      isOpen: false,
      isCompleted: false,
    },
  ]);
